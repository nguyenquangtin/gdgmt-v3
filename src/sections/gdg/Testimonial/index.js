      ...
      >
        ...
        <div className="container-fluid">
          <div data-aos="zoom-in" data-aos-duration={800} data-aos-once="true">
            ...
            >
              {TestimonialData.map(({imageUrl,mediaName,postUrl,text},index) => {
                return (
                  <SwiperSlide key={index}>
                    <Card imageUrl={imageUrl} mediaName={mediaName} postUrl={postUrl} text={text}/>
                  </SwiperSlide>
                )
              })}
            </Swiper>
